            ...
            do
                ...
                do
                    ...
                    do
                        ...
                        echo "Start ${c}"
                        output_file="../exp_logs/link_prediction_${a}_verity_${rank}_${embedding_dim}_${seed}_${feature_dim}.txt"
                        ...
                        CUDA_VISIBLE_DEVICES=$most_idle_gpu nohup python link_prediction.py --dataset $a --rank $rank --embedding_dim $embedding_dim --seed $seed --feature_dim $feature_dim --cluster 0 > $output_file 2>&1 &
