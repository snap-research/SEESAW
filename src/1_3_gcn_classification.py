...
if __name__ == "__main__":
    ...
    if args.write == 1:
        if args.cluster == 1:
            ...
            # ) as file:
            #     line = (
            #         f"gcn,{args.dataset},{args.rank:.1f},{args.embedding_dim:.1f},{args.p:.1f},{args.q:.1f},{args.feature_dim:.8f},{args.seed:.1f},"
            #         + comp_string
            #         + "\n"
            #     )
            #     file.write(line)
            ...
            # np.save(
            #     f"../../1_classification/gcn_{args.dataset}_{args.rank:.0f}_{args.embedding_dim:.0f}_{args.p:.0f}_{args.q:.0f}_{args.feature_dim:.8f}_{args.seed:.0f}.npy",
            #     prediction_dict,
            # )
            ...
            np.save(
                f"../example_results/gcn_nc_{args.dataset}_{args.rank:.0f}_{args.embedding_dim:.0f}_{args.p:.0f}_{args.q:.0f}_{args.feature_dim:.8f}_{args.seed:.0f}.npy",
                prediction_dict,
            )
