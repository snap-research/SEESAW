...
if __name__ == "__main__":
    ...
    if args.write == 1:
        if args.cluster == 1:
            ...
            # np.save(
            #     f"../../1_link_prediction/sage_{args.dataset}_{args.rank:.0f}_{args.embedding_dim:.0f}_{args.p:.0f}_{args.q:.0f}_{args.feature_dim:.8f}_{args.seed:.0f}.npy",
            #     prediction_dict,
            # )
            ...
            np.save(
                f"../example_results/sage_lp_{args.dataset}_{args.rank:.0f}_{args.embedding_dim:.0f}_{args.p:.0f}_{args.q:.0f}_{args.feature_dim:.8f}_{args.seed:.0f}.npy",
                prediction_dict,
            )
